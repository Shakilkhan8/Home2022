...
class MagentoProductTemplate(models.Model):
    ...
    product_expiry = fields.Datetime(string='Expiry Date')
    magento_product_barcode = fields.Char(string='Barcode')
    brand = fields.Many2one('magento.attribute.option', string='Magento Brand')
